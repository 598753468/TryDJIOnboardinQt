...
//wei
/*extern */bool IsSerialPortOpened = false;
/*extern */bool IsActivated = false;
/*extern*/ bool IsUnderControl = false;
...
void GetControl_CallBack(unsigned short res)
{
    ...
    case 2:
        IsUnderControl = true;
        std::cout<<"Under Control!"<<std::endl;
        break;
    default:
...
// 获取GPS
int DJI_Pro_Get_GPS(api_pos_data_t *p_user_buf)
{
    pthread_mutex_lock(&std_msg_lock);
